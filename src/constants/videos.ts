...
import VisionTechBackground from "../assets/videos/vision-video.mp4";
import VoiceTechBackground from "../assets/videos/voice-video.mp4";

export default {
  DefenseVideo,
  AdvertisingVideo,
  SocialTechBackground,
  TranslationsTechBackground,
  VisionTechBackground,
  VoiceTechBackground,
};
