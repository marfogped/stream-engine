...
const index = () => {
  return (
    <section
      className="min-h-[65dvh] lg:min-h-[100dvh] relative bg-cover bg-center bg-no-repeat flex p-2.5 video-overlay"
      style={{
        backgroundImage: `url(${images.CareersBackground})`,
      }}
    >
      <div className="lg:w-1/2 w-full bg-black/70 backdrop-blur-md rounded-3xl flex flex-col items-start justify-between pt-20 px-5 pb-5 lg:p-20 lg: z-[2]">
        <div>
          <Typography
            as="h1"
            variant="xxl"
