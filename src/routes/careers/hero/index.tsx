...
const index = () => {
  return (
    <section
      className="h-[70dvh] lg:h-[100dvh] relative bg-cover bg-center bg-no-repeat flex p-2.5 video-overlay"
      style={{
        backgroundImage: `url(${images.CareersBackground})`,
      }}
    >
      <div className="lg:w-1/2 w-full bg-black/70 backdrop-blur-md h-full rounded-3xl flex flex-col items-center lg:items-start justify-between py-14 lg:p-20 lg: z-[2]">
        <div>
          <Typography
            as="h1"
            variant="xxl"
